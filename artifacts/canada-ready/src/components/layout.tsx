    ...
    <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "rgba(245,254,253,0.98)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(102,230,222,0.22)", height: "68px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", height: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", padding: "0 5%" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <Link href="/assessment" className="hidden lg:flex" style={{ background: `linear-gradient(135deg, var(--gold) 0%, var(--gold-lt) 100%)`, color: "var(--tiffany-dk)", border: "1px solid rgba(201,144,58,0.35)", padding: "11px 20px", borderRadius: "24px", fontSize: "13px", fontWeight: 800, cursor: "pointer", textDecoration: "none", transition: "0.25s", whiteSpace: "nowrap", alignItems: "center", gap: "7px", flexShrink: 0, boxShadow: "0 10px 24px rgba(201,144,58,0.28)" }} data-testid="nav-cta">
