...
export function Navbar() {
  ...
  const links = [
    ...
    { href: "/about", label: "About / عنّا" },
    { href: "/programs", label: "Programs / البرامج" },
    { href: "/services", label: "All Services / كل الخدمات" },
    { href: "/how-it-works", label: "How It Works / كيف يعمل" },
    { href: "/testimonials", label: "Testimonials / آراء الطلاب" },
    { href: "/contact", label: "Contact / تواصل" },
  ];

  const mobileLinks = [
    { href: "/", emoji: "🏠", label: "Home / الرئيسية" },
    { href: "/about", emoji: "ℹ️", label: "About / عنّا" },
    { href: "/programs", emoji: "📚", label: "Programs / البرامج" },
    { href: "/services", emoji: "🧾", label: "All Services / كل الخدمات" },
    { href: "/how-it-works", emoji: "🔄", label: "How It Works / كيف يعمل" },
    { href: "/assessment", emoji: "📋", label: "Free Assessment / تقييم مجاني", highlight: true },
    { href: "/testimonials", emoji: "⭐", label: "Testimonials / آراء الطلاب" },
    { href: "/contact", emoji: "📞", label: "Contact / تواصل" },
  ];
      ...
      {mobileOpen && (
        <div style={{ position: "fixed", top: "68px", left: 0, right: 0, background: "#fff", zIndex: 999, borderBottom: "1px solid rgba(10,186,181,0.15)", padding: "16px 5%", display: "flex", flexDirection: "column", gap: "3px" }}>
          ...
          <a href="https://wa.me/15870000000" target="_blank" rel="noopener noreferrer" onClick={() => setMobileOpen(false)} style={{ display: "flex", alignItems: "center", gap: "8px", background: "#25D366", color: "#fff", textDecoration: "none", padding: "11px 15px", borderRadius: "11px", fontWeight: 700, fontSize: "14px", marginTop: "6px" }}>
            💬 Chat on WhatsApp / تحدث على واتساب
          </a>
        </div>
      )}
    </nav>
...
export function Footer() {
  const navLinks = [
    ...
    { href: "/services", label: "All Services / كل الخدمات" },
    { href: "/how-it-works", label: "How It Works / كيف يعمل" },
    { href: "/assessment", label: "Free Appointment / موعد مجاني" },
    { href: "/testimonials", label: "Testimonials / آراء الطلاب" },
    { href: "/contact", label: "Contact / تواصل" },
  ];
  ...
  return (
    <footer style={{ background: "#004D4B", color: "rgba(255,255,255,0.55)", paddingTop: "54px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "2fr 1fr 1.4fr", gap: "38px", paddingBottom: "42px", padding: "0 5% 42px" }}>
        ...
        {/* Quick links */}
        <div>
          <h4 style={{ color: "#fff", fontSize: "11.5px", fontWeight: 700, letterSpacing: "1.2px", textTransform: "uppercase", marginBottom: "13px", fontFamily: "'Outfit', sans-serif" }}>Quick Links / روابط سريعة</h4>
